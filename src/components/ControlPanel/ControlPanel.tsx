  ...
  return (
    <div className={cn('bg-white rounded-lg shadow-lg p-6 space-y-6', className)}>
      ...
      <div className="flex items-center gap-2">
        ...
        <h2 className="text-xl font-semibold text-gray-800">跑馬燈控制台</h2>
      </div>
      ...
      <div className="flex gap-3">
        ...
        <button
          ...
          className="flex items-center gap-2 px-4 py-2 bg-purple-500 hover:bg-purple-600 text-white rounded-md transition-colors font-medium"
        >
